declare global {
    ...
    /** 문화정보 리스트 params */
    interface API_CLIENT_CULTURE_INFO_LIST_PARAMS extends LIST_API_PARAMS {
    ...
    interface API_SERVER_CULTURE_INFO_LIST_PARAMS {
        /** 페이지 번호 */
        offset : number,
    ...
    type API_SERVER_CULTURE_LIST = RESPONSE_MODEL<INFINITY_RESPONSE_ITEM<CULTURE_ITEM[]>>


    type API_CLIENT_CULTURE_LIST = INFINITY_RESPONSE_ITEM<CULTURE_ITEM[]>;
